...
int main(){
    ...
    unsigned char command1[8] = {0x01, 0x03, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00};
    printf("\n\n%x\n\n", GetCRC16(command1, 6));
    unsigned char command2[8] = {0x02, 0x03, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00};
    printf("\n\n%x\n\n", GetCRC16(command2, 6));
    unsigned char command3[8] = {0x03, 0x03, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00};
    printf("\n\n%x\n\n", GetCRC16(command3, 6));
    unsigned char command4[8] = {0x04, 0x03, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00};
    printf("\n\n%x\n\n", GetCRC16(command4, 6));
