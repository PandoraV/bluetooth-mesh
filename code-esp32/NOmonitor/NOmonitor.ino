...
#define SERVICE_UUID           "4195d137-3369-4470-a778-976ed91ce6f6" // UART service UUID
#define CHARACTERISTIC_UUID_RX "4195d138-3369-4470-a778-976ed91ce6f6" // 收信
#define CHARACTERISTIC_UUID_TX "4195d139-3369-4470-a778-976ed91ce6f6" // 发信

#define ADDRESS_PRESENT_SLAVE 2 // 从机地址位
int info_num = 6; // 传回上位机信息条数，测试时仅有温湿度两项
...
void setup() {
  ...
  BLEDevice::init("NOx Monitor");                // Create the BLE Device
